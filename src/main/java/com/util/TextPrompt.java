...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
    ...
    public TextPrompt(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS, JLabel.LEADING);
    }

    public TextPrompt(String text, JTextComponent component, int orientation) {
        this(text, component, Show.ALWAYS, orientation);
    }

    public TextPrompt(String text, JTextComponent component, Show show, int orientation) {
...
//	setBorder(new EmptyBorder(component.getInsets()));
	setHorizontalAlignment( this.orientation);
